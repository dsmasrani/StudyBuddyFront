  ...
  render() {
    ...
    <div class="container">
        <div class="addkey-body">
            ...
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-person" />
                  </svg>
                  Id: ${this.profile.id}</p></div>
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-email" />
                  </svg>
                Email: ${this.profile.user_email}</p></div>
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-openapi" />
                  </svg>
                  OpenAPI Key: ${this.profile.openai_key}</p></span></div>
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-pineapi" />
                  </svg>
                  Pinecone API Key: ${this.profile.pinecone_key}</p></span></div>
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-pineenv" />
                  </svg>
                  Pinecone Environment: ${this.profile.pinecone_env} </p></span></div>
            <div><p>
                <svg class="icon">
                    <use href="./../assets/icons/profile.svg#icon-index" />
                  </svg>
